...
let htmlToJsCssPath=function(_sourcePath){
  ...
  if(config.html.buildJsCss===0){
    ...
    jsPath=jsCssSourceDir+samePath.replace(/^(.*)(\/)(.*)$/,"$1$2js/$3")+".js";//返回d:/www/uielf.com/media/js/a/index.js
    cssPath=jsCssSourceDir+samePath.replace(/^(.*)(\/)(.*)$/,"$1$2css/$3")+".css";//返回d:/www/uielf.com/media/css/a/index.css
  }
  return {
    "jsPath":jsPath,
    "cssPath":cssPath
