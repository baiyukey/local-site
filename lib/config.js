 ...
 */
let root="./test/webFile/";//项目目录,访问网址为“/”，也是根目录
...
module.exports={
  ...
  'elfFrame':{//暂未开放
    'enable':false,//是否对elfFrame的支持,当为true时，在watchDir中创建html文件时会在uglifyJsCss.watchDir下的js/、css/目录中创建对应的文件,默认false,即不支持,想了解elfFrame？点击：http://www.uiElf.com/elfFrame/
