 ...
 * @version ^0.6.1
 */
let root="d:/www/uielf.com/version01/";//项目目录,访问网址为“/”，也是根目录
let virtualRoot=`${root}html/`;//虚拟根目录，访问网址为“/”，必选项
export default {
  'hostname':'127.0.0.1',//主机名，也可以设置成本机的IP地址，默认localhost
  ...
  'html':{
    /**
     * @param {Number} [buildJsCss=[0(默认),1,2]] 是否创建，在哪创建html关联的js和css文件
