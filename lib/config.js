 ...
 */
let rootDir="../../root/";//即网站根目录地址 (该目录是相对于local-site根目录的地址)
module.exports={
  ...
  'templateDir':rootDir+'template/',//html文件根目录,用于存放html文件
  'homePage':'/helloWord.html',//项目首页，存放于templateDir目录下，用于服务成功启动后的链接展示
  'apiDir':'./api/',//后台程序,api接口目录
  'apiProxy':'http://10.10.10.34:8000',//Create an HTTP proxy server with an HTTP target
  'uglifyJsCss':{
    'enable':true,//是否开启代码压缩功能，默认true，即开启
    'watchDir':rootDir+'media/user/',//当监视目录下的js/,css/目录文件发生变化时自动压缩混淆到js.min/、css.min/目录
